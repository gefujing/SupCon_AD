...
sce.all.filt.harmony = as.SingleCellExperiment(sce.all.filt.harmony)
sce.all.filt.harmony = Milo(sce.all.filt.harmony)

# Construct KNN
traj_milo = buildGraph(sce.all.filt.harmony, k = 10, d = 30)
